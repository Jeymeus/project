 ...
 */
final class Version20240506143648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE availability (id INT AUTO_INCREMENT NOT NULL, vehicle_id INT DEFAULT NULL, start_date DATETIME DEFAULT NULL, end_date DATETIME DEFAULT NULL, price_per_day DOUBLE PRECISION DEFAULT NULL, status TINYINT(1) DEFAULT NULL, INDEX IDX_3FB7A2BF545317D1 (vehicle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
